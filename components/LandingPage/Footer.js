  ...
  return (
    ...
    >
      ...
      <footer className="self-stretch flex flex-row items-start justify-start py-8 px-[145px] box-border relative gap-[39.9px] max-w-full text-left text-sm text-darkgray font-poppins mq800:gap-5 mq800:pl-9 mq800:pr-9 mq800:box-border mq1350:flex-wrap mq1350:justify-center mq1350:pl-[72px] mq1350:pr-[72px] mq1350:box-border">
        ...
        <div className="!m-[0] absolute top-[calc(50%_-_20px)] right-[165px] flex flex-row items-start justify-start gap-4">
          <div className="h-10 w-10 relative rounded-2xl bg-lightsteelblue-100 z-[1]" />
          <div className="h-10 w-10 relative rounded-2xl bg-lightsteelblue-100 z-[1]" />
        </div>
        <div className="flex flex-col items-start justify-start pt-[7px] px-0 pb-0">
          <img
            className="w-[15.1px] h-[14.4px] relative z-[2]"
            loading="lazy"
            alt=""
            src="/vector-6.svg"
          />
        ...
        <div className="flex flex-col items-start justify-start pt-[7px] px-0 pb-0">
          <img
            className="w-[18.8px] h-[14.4px] relative z-[2]"
            loading="lazy"
            alt=""
            src="/vector-7.svg"
          />
